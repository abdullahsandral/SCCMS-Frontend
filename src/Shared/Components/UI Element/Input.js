...
const Input = props =>
{
    ...
    <input  className = {!inputState.inputIsValid && inputState.touched ? notValidInputClass : null} id={props.id}
    ...
    return (
        <div>
        {props.Label && <label className = {`${!inputState.inputIsValid && inputState.touched && notValidLabelClass}`}><b>{props.Label}</b></label>}
        {InputType}
